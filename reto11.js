...
function decodeFilename(filename) {
    let posicion = filename.indexOf('_');
    console.log(posicion);
    let nombre = filename.slice(posicion+1);
    let lastPunto = nombre.lastIndexOf('.');

    nombre = nombre.slice(0,lastPunto);
    
    return nombre;
  }
 decodeFilename('123_file.version1.backup.tar.gz');
 
  decodeFilename('sleighDesign.png.grinchwa')
// ➞ "sleighDesign.png"
